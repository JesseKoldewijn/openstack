...
Ensures S3 write operations are safe under concurrent access. Multiple simultaneous PutObject or UploadPart requests targeting the same key must not corrupt each other's in-progress data or the final object at the canonical path.
