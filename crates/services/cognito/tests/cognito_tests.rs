...
async fn test_describe_user_pool() {
    let p = CognitoProvider::new();
    let create_resp = p
        .dispatch(&make_ctx("CreateUserPool", json!({ "PoolName": "desc-pool" })))
        .await
        .unwrap();
    ...
    let resp = p
        .dispatch(&make_ctx("DescribeUserPool", json!({ "UserPoolId": pool_id })))
        .await
        .unwrap();
    assert_eq!(resp.status_code, 200);
    let b = body_json(&resp);
...
async fn test_describe_user_pool_not_found() {
    ...
    let b = body_json(&resp);
    assert!(b["__type"].as_str().unwrap().contains("ResourceNotFoundException"));
}
...
async fn test_delete_user_pool() {
    let p = CognitoProvider::new();
    let create_resp = p
        .dispatch(&make_ctx("CreateUserPool", json!({ "PoolName": "del-pool" })))
        .await
        .unwrap();
    let pool_id = body_json(&create_resp)["UserPool"]["Id"]
        .as_str()
    ...
    let resp = p
        .dispatch(&make_ctx("DeleteUserPool", json!({ "UserPoolId": pool_id })))
        .await
        .unwrap();
    assert_eq!(resp.status_code, 200);
...
async fn test_update_user_pool() {
    let p = CognitoProvider::new();
    let create_resp = p
        .dispatch(&make_ctx("CreateUserPool", json!({ "PoolName": "upd-pool" })))
        .await
        .unwrap();
    let pool_id = body_json(&create_resp)["UserPool"]["Id"]
        .as_str()
...
async fn test_create_and_describe_client() {
    let p = CognitoProvider::new();
    let pool_resp = p
        .dispatch(&make_ctx("CreateUserPool", json!({ "PoolName": "client-pool" })))
        .await
        .unwrap();
    ...
    let client_id = b["UserPoolClient"]["ClientId"].as_str().unwrap().to_string();
...
async fn test_list_user_pool_clients() {
    let p = CognitoProvider::new();
    let pool_resp = p
        .dispatch(&make_ctx("CreateUserPool", json!({ "PoolName": "list-clients-pool" })))
        .await
        .unwrap();
    let pool_id = body_json(&pool_resp)["UserPool"]["Id"]
        .as_str()
...
async fn test_delete_client() {
    let p = CognitoProvider::new();
    let pool_resp = p
        .dispatch(&make_ctx("CreateUserPool", json!({ "PoolName": "del-client-pool" })))
        .await
        .unwrap();
    let pool_id = body_json(&pool_resp)["UserPool"]["Id"]
        .as_str()
...
async fn test_admin_create_and_get_user() {
    let p = CognitoProvider::new();
    let pool_resp = p
        .dispatch(&make_ctx("CreateUserPool", json!({ "PoolName": "user-pool" })))
        .await
        .unwrap();
    let pool_id = body_json(&pool_resp)["UserPool"]["Id"]
        .as_str()
...
async fn test_admin_create_user_duplicate_fails() {
    let p = CognitoProvider::new();
    let pool_resp = p
        .dispatch(&make_ctx("CreateUserPool", json!({ "PoolName": "dup-user-pool" })))
        .await
        .unwrap();
    let pool_id = body_json(&pool_resp)["UserPool"]["Id"]
        .as_str()
...
async fn test_list_users() {
    let p = CognitoProvider::new();
    let pool_resp = p
        .dispatch(&make_ctx("CreateUserPool", json!({ "PoolName": "list-users-pool" })))
        .await
        .unwrap();
    let pool_id = body_json(&pool_resp)["UserPool"]["Id"]
        .as_str()
...
async fn test_admin_delete_user() {
    let p = CognitoProvider::new();
    let pool_resp = p
        .dispatch(&make_ctx("CreateUserPool", json!({ "PoolName": "del-user-pool" })))
        .await
        .unwrap();
    let pool_id = body_json(&pool_resp)["UserPool"]["Id"]
        .as_str()
    ...
    assert!(body_json(&get_resp)["__type"]
        .as_str()
        .unwrap()
...
async fn test_admin_set_user_password() {
    let p = CognitoProvider::new();
    let pool_resp = p
        .dispatch(&make_ctx("CreateUserPool", json!({ "PoolName": "pw-pool" })))
        .await
        .unwrap();
    let pool_id = body_json(&pool_resp)["UserPool"]["Id"]
        .as_str()
...
async fn test_admin_enable_disable_user() {
    let p = CognitoProvider::new();
    let pool_resp = p
        .dispatch(&make_ctx("CreateUserPool", json!({ "PoolName": "en-dis-pool" })))
        .await
        .unwrap();
    let pool_id = body_json(&pool_resp)["UserPool"]["Id"]
        .as_str()
...
async fn test_admin_update_user_attributes() {
    let p = CognitoProvider::new();
    let pool_resp = p
        .dispatch(&make_ctx("CreateUserPool", json!({ "PoolName": "attr-pool" })))
        .await
        .unwrap();
    let pool_id = body_json(&pool_resp)["UserPool"]["Id"]
        .as_str()
    ...
    let get_resp = p
        ...
        .await
        .unwrap();
    let attrs = body_json(&get_resp)["Attributes"].as_array().unwrap().clone();
    assert!(attrs
        .iter()
...
async fn test_admin_initiate_auth_success() {
    let p = CognitoProvider::new();
    let pool_resp = p
        .dispatch(&make_ctx("CreateUserPool", json!({ "PoolName": "auth-pool" })))
        .await
        .unwrap();
    let pool_id = body_json(&pool_resp)["UserPool"]["Id"]
        .as_str()
...
async fn test_admin_initiate_auth_wrong_password() {
    let p = CognitoProvider::new();
    let pool_resp = p
        .dispatch(&make_ctx("CreateUserPool", json!({ "PoolName": "auth-fail-pool" })))
        .await
        .unwrap();
    let pool_id = body_json(&pool_resp)["UserPool"]["Id"]
        .as_str()
